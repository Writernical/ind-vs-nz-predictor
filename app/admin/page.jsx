...
import { ALL_PLAYERS, INDIA_PLAYERS, NZ_PLAYERS, INDIA_SCORING, NZ_SCORING, INDIA_BOWLING, NZ_BOWLING, SIXES_RANGES, WICKET_OVERS, POWERPLAY_RANGES, INDIVIDUAL_RANGES, POINTS, calculateScore } from "@/lib/constants";
...
export default function AdminPage() {
  ...
  return (<div>
    ...
    {[
      ...
      ["⚡", "Powerplay", { o: POWERPLAY_RANGES, k: "powerplay_score", c: 3 }],
